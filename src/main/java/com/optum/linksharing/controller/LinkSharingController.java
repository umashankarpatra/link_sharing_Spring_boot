package com.optum.linksharing.controller;

import static com.optum.linksharing.common.util.HeaderUtil.addError;
import static com.optum.linksharing.common.util.HeaderUtil.addSuccess;
import static com.optum.linksharing.common.util.RateMessageConstants.DEACTIVATE_LINK_NOT_AVALIABLE;
import static com.optum.linksharing.common.util.RateMessageConstants.LINK_COUNT_UPDATED_SUCCESSFULLY;
import static com.optum.linksharing.common.util.RateMessageConstants.LINK_COUNT_UPDATE_FAILED;
import static com.optum.linksharing.common.util.RateMessageConstants.RECORD__NOT_FOUND;
...
import com.optum.linksharing.common.util.ImmutableCollectors;
import com.optum.linksharing.model.Link;
import com.optum.linksharing.model.link.dto.LinkRequest;
import com.optum.linksharing.model.link.dto.LinkResponse;
import com.optum.linksharing.pagination.PaginatedResource;
import com.optum.linksharing.pagination.PaginatedResourceAssembler;
